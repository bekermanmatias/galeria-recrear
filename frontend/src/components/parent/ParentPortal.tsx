  ...
  const uniqueDates = useMemo(
    () =>
      Array.from(
        new Set(
          albums
            .filter((album) => album.schoolId === schoolId)
        ...
        >
          ...
          <main style={{ flex: 1, overflowY: "auto", padding: 24 }}>
            {loading ? (
              ...
              <Empty text="No hay álbumes publicados con estos filtros." />
            )}
          </main>
        </div>
      )}
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {selectionMode ? (
            ...
            <>
              ...
              <button
                onClick={() =>
                  void download(album.media.map((item) => item.id))
                }
                disabled={downloading}
                aria-busy={downloading}
                style={{
          ...
          {downloadError && (
            <span
              role="alert"
              style={{ color: "#B91C1C", fontSize: 12, alignSelf: "center" }}
            >
              {downloadError}
            </span>
          )}
                ...
                {!selectionMode && (
                  <>
                    ...
                    >
                      <DownloadButton
                        compact
                        load={() => fetchDownload(api.downloadUrl(item.id))}
