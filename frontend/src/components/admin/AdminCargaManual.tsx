        ...
        {files.length > 0 && (
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{
              ...
              {files.map(f => (
                <div key={f.id} onClick={() => setSelectedPhoto(f.preview)} style={{ position: 'relative', aspectRatio: '1', overflow: 'hidden', background: '#F4F4F5', borderRadius: '4px', cursor: 'pointer' }}>
